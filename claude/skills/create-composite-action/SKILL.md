...
description: Use when the user wants to create a new composite action repo from the standard template. Delegates the create, clone, and release to the repo-scaffolder agent in isolation, then settles open PRs and cleans up scaffolding.
arguments:
  - name
---
...
4. Report the repo URL and local path. The directory is ready to start implementing the action.
